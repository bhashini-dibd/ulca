const FooterStyle = (theme) => ({
    ...
    social :{display:"flex",marginLeft:"auto",width:"40%",justifyContent:"space-between","@media  (max-device-width : 400px)": { marginTop:"20px"}},
    container:{width:"100%",display:"flex",boxSizing:"border-box",flexWrap:"wrap" },
    bhasini:{display:"flex",marginRight:"auto",width:"80%",justifyContent:"space-between",marginTop:"10px", "@media  (max-device-width : 400px)": { width:"100%"},},
