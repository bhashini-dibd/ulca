const FooterStyle = (theme) => ({
    ...
    social :{display:"flex",marginLeft:"auto",width:"40%",justifyContent:"space-between"},
    container:{width:"100%",display:"flex",boxSizing:"border-box",flexWrap:"wrap"},
    bhasini:{display:"flex",marginRight:"auto",width:"80%",justifyContent:"space-between",marginTop:"10px"},
