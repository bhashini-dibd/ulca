 ...
 */
 ...
 export default class GetTransliterationModelID extends API {
   ...
   constructor(
     ...
     this.queryStr = sourceLang && targLang ? `sourceLanguage=${sourceLang}&targetLanguage=${targLang}` : `sourceLanguage=${sourceLang}`;
     this.endpoint = `${super.apiEndPointAuto()}${ENDPOINTS.getTransliterationModelId}?${this.queryStr}`;
