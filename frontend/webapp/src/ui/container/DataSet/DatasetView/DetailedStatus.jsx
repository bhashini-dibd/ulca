        ...
        const fetchHeaderButton= () => {
                return (
                        <div className={classes.headerButtons}>
                                ...
                                { <Button color={"primary" } size="medium" className = {classes.ButtonRefresh} variant="outlined" disabled={(status==="In-Progress" || status==="Pending")? false:true}   onClick={() => DetailedDataSetStatusApi()}><Cached className ={classes.iconStyle}/>Refresh</Button>}
