        ...
        const fetchHeaderButton= () => {
                return (
                        <div className={classes.headerButtons}>
                                ...
                                { <Button color={"primary" } size="medium" className = {classes.ButtonRefresh} variant="outlined" disabled={(status.toLowerCase()==="in-progress" || status.toLowerCase()==="failed")? false:true}   onClick={() => DetailedDataSetStatusApi()}><Cached className ={classes.iconStyle}/>Refresh</Button>}
