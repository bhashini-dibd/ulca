...
const ChartRender = (props) => {
    ...
    fetch(apiObj.apiEndPoint(), {
      ...
      .then(async (response) => {
        ...
        if (!response.ok) {
          ...
          setData(res);
          let total = rsp_data.data.reduce(
  ...
  const fetchFilterButtons = () => {
    return (
      <div className={classes.filterButton}>
        ...
        <Button
          color={filterValue === "language" ? "primary" : "default"}
        ...
        <Button
          color={filterValue === "domain" ? "primary" : "default"}
          size="small"
          variant="outlined"
        ...
        <Button
          color={filterValue === "submitter" ? "primary" : "default"}
          size="small"
          variant="outlined"
          onClick={() => handleLanguageChange("submitter")}
        >
          Submitter
        </Button>
      </div>
  ...
  const handleSelectChange = (dataSet, event, filter, page) => {
    ...
    if (page === 0) {
      ...
      setTitle(
        `Number of ${
          selectedTypeName ? selectedTypeName : event.label
        } Benchmark Datasets - Grouped by ${
          filter
      ...
      <div class="text-center">
        ...
        <div class="join">
          <a
            ...
            href={`${process.env.REACT_APP_BASE_URL}/ulca/model/benchmark-datasets`}
            target="_self"
            rel="noopener noreferrer"
          >
            <span>Explore Benchmark Datasets</span>
          </a>
        </div>
      </div>
