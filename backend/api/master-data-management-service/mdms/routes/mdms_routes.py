...
from resources import MasterDataResource,FeedbackDataResource, BulkMasterDataResource, CacheBustResource
...
Api(MDMS_BLUEPRINT).add_resource(FeedbackDataResource, "/v0/fetch-master/feedback")
