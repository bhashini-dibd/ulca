...
from resources import MasterDataResource, BulkMasterDataResource, CacheBustResource, PipeLineFeedBack
...
Api(MDMS_BLUEPRINT).add_resource(PipeLineFeedBack, "/v0/pipelineQuestions")
