...
ROLE_CODES_URL          =   os.environ.get('UMS_ROLE_CODES_URL','https://raw.githubusercontent.com/bhashini-dibd/ulca/master/backend/api/ulca-zuul-api-gw/dev-configs/roles.json')
