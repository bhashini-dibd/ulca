...
BHAHSINI_GLOSSARY_CREATE_URL = os.environ.get('DHRUVA_GLOSSARY_FETCH_ENDPOINT',"https://bhashini-dhruva-staging-backend-app-service.azurewebsites.net/services/glossary/v1/fetch-all")
BHAHSINI_GLOSSARY_CREATE_URL = os.environ.get('DHRUVA_GLOSSARY_DELETE_ENDPOINT',"https://bhashini-dhruva-staging-backend-app-service.azurewebsites.net/services/glossary/v1/delete")
