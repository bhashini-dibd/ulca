...
@JsonDeserialize(as = CollectionDetailsAutoAligned.class)
public class CollectionDetailsAutoAligned  implements OneOfParallelDatasetCollectionMethodCollectionDetails {
  /**
