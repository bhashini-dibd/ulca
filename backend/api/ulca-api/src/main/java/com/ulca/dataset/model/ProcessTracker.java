...
public class ProcessTracker   {
  ...
  public ProcessTracker startTime(BigDecimal startTime) {
  ...
  public ProcessTracker endTime(BigDecimal endTime) {
  ...
  public ProcessTracker lastModified(BigDecimal lastModified) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userId, datasetId, serviceRequestNumber, serviceRequestType, serviceRequestAction, status, details, startTime, endTime, lastModified, error);
  }
