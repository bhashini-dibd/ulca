...
public class KafkaBenchmarkDownloadConsumerConfig {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ExecuteBenchmarkRequest> benchmarkDownloadKafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, ExecuteBenchmarkRequest> factory = new ConcurrentKafkaListenerContainerFactory<String, ExecuteBenchmarkRequest>();
