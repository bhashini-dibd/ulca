 ...
 * Task Tracker entity
 */
@Schema(description = "Benchmark Dataset Submit Stages entity")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2021-06-08T12:36:29.236Z[GMT]")

@Document(collection = "ulca-bm-submit-stages")
public class BenchmarkDatasetSubmitStages   {
  @JsonProperty("serviceRequestNumber")
  private String serviceRequestNumber = null;

  /**
   * ToolEnum contains only two stages [ download, validate ] for benchmark dataset submit
   */
 ...
 // @DateTimeFormat(iso=ISO.DATE_TIME)
  ...
  public BenchmarkDatasetSubmitStages serviceRequestNumber(String serviceRequestNumber) {
  ...
  public BenchmarkDatasetSubmitStages tool(ToolEnum tool) {
    this.tool = tool;
    return this;
  }
  ...
  public BenchmarkDatasetSubmitStages status(String status) {
    this.status = status;
    return this;
  }
  ...
  public BenchmarkDatasetSubmitStages details(String details) {
  ...
  public BenchmarkDatasetSubmitStages startTime(String startTime) {
  ...
  public BenchmarkDatasetSubmitStages endTime(String endTime) {
  ...
  public BenchmarkDatasetSubmitStages lastModified(String lastModified) {
  ...
  public BenchmarkDatasetSubmitStages error(BenchmarkError error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BenchmarkDatasetSubmitStages taskTracker = (BenchmarkDatasetSubmitStages) o;
