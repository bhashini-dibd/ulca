...
public class OkHttpClientConfig {
   ...
   private String keystore;
    ...
    public OkHttpClient getSslOkHttpClient() throws Exception {
        ...
        try (InputStream in = getResourceAsStream(keystore)) {
            if (in == null) {
        ...
        try (InputStream in = getResourceAsStream(truststore)) {
            if (in == null) {
                throw new IllegalArgumentException("Truststore file not found: " + truststore);
            }
