package com.ulca.benchmark.kafka.listener;
...
public class KafkaBenchmarkDownloadConsumer {
	...
	@Autowired
	private KafkaTemplate<String, BenchmarkDownload> datasetIngestKafkaTemplate;
	...
	public void downloadFile(BenchmarkDownload file) {

		String datasetId = file.getId();
...
//		
	...
	private String fileMD5hash(String filePath) throws IOException {
		...
		try {
			hash = com.google.common.io.Files.hash(new File(filePath), Hashing.md5());
