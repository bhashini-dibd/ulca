 ...
 * com.ulca.benchmark.request.*; import
 * com.ulca.benchmark.service.BenchmarkService; import
 ...
 * 
 * @ExtendWith(MockitoExtension.class) class BenchmarkControllerTest {
 * 
 * @InjectMocks private BenchmarkController benchmarkController;
 * 
 ...
 * MockMvcBuilders.standaloneSetup(benchmarkController).build();
 * 
 * }
 * 
 ...
 * 
 * @Test void executeBenchmark() throws Exception { ExecuteBenchmarkRequest
 * request = new ExecuteBenchmarkRequest();
 * 
 * 
 * mapper = new ObjectMapper(); String json =
 * mapper.writeValueAsString(request);
 * 
 * mockMvc.perform(MockMvcRequestBuilders.post(BASE_URL+"/execute").contentType(
 * MediaType.APPLICATION_JSON) .content(json)
 * .accept(MediaType.APPLICATION_JSON)).
 * andExpect(MockMvcResultMatchers.status().isOk()); }
 * 
 * 
 * @Test void executeBenchmarkAllMetric() throws Exception {
 * ExecuteBenchmarkAllMetricRequest request = new
 * ExecuteBenchmarkAllMetricRequest();
 * 
 * mapper = new ObjectMapper(); String json =
 * mapper.writeValueAsString(request);
 * 
 * mockMvc.perform(MockMvcRequestBuilders.post(BASE_URL+"/execute/allMetric").
 * contentType(MediaType.APPLICATION_JSON) .content(json)
 * .accept(MediaType.APPLICATION_JSON)).
 * andExpect(MockMvcResultMatchers.status().isOk()); }
 * 
 * @Test void getBenchmarkById() throws Exception {
 * mockMvc.perform(MockMvcRequestBuilders.get(BASE_URL+"/getBenchmark").param(
 * "benchmarkId","test")). andExpect(MockMvcResultMatchers.status().isOk()); }
 * 
 * 
 * 
 ...
 * 
 * 
 * @Test void searchBenchmark() throws Exception { BenchmarkSearchRequest
 * request = new BenchmarkSearchRequest(); request.setTask("test");
 * 
 * mapper = new ObjectMapper(); String json =
 * mapper.writeValueAsString(request);
 * 
 ...
 * andExpect(MockMvcResultMatchers.status().isOk()); }
 * 
 * @Test void processStatus() throws Exception {
 * mockMvc.perform(MockMvcRequestBuilders.get(BASE_URL+"/process/status").param(
 * "benchmarkProcessId","test")).
 * andExpect(MockMvcResultMatchers.status().isOk()); } }
 */