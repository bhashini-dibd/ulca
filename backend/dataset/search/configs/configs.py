...
app_host = os.environ.get('ULCA_DS_SEARCH_HOST', '0.0.0.0')
app_port = os.environ.get('ULCA_DS_SEARCH_PORT', 5001)
...
ulca_dataset_search_consumer_grp = os.environ.get('KAFKA_ULCA_DS_SEARCH_CONSUMER_GRP', 'ulca-ds-search-consumer-group-v0')
