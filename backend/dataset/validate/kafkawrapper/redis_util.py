...
from configs.configs import redis_server_host, redis_server_port, redis_server_pass, record_expiry_in_sec, validate_dedup_redis_db
...
class RedisUtil:
    ...
    def redis_instantiate(self):
        ...
        redis_dedup_records = redis.Redis(host=redis_server_host, port=redis_server_port, db=validate_dedup_redis_db,
