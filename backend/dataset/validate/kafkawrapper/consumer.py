...
from configs.configs import dataset_type_parallel, dataset_type_asr, dataset_type_ocr, dataset_type_monolingual, dataset_type_asr_unlabeled, dataset_type_tts, dataset_type_transliteration
...
def consume():
    try:
        ...
        p_service, o_service, a_service, m_service, au_service, t_service, tl_service = ParallelValidate(), OCRValidate(), ASRValidate(), MonolingualValidate(), ASRUnlabeledValidate(), TTSValidate(), TransliterationValidate()
        pt = ProcessTracker()
        prod = Producer()
