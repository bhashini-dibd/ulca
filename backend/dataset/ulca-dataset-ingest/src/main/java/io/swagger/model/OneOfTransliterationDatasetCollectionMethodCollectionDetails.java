 ...
 * 
 * @JsonSubTypes.Type(value = CollectionDetailsMachineTransliterated.class, name
 * = "CollectionDetailsMachineTransliterated"),
 * 
 * @JsonSubTypes.Type(value =
 * CollectionDetailsMachineTransliteratedPostEdited.class, name =
 * "CollectionDetailsMachineTransliteratedPostEdited"),
 * 
 * @JsonSubTypes.Type(value = CollectionDetailsManualTransliterated.class, name
