...
public class DatasetDocumentLayoutValidateIngest implements DatasetValidateIngest{
	...
	public DocumentLayoutParamsSchema validateParamsSchema(DatasetIngest datasetIngest)
		...
		String paramsFilePath = datasetIngest  + File.separator + "params.json";
		...
		DocumentLayoutParamsSchema paramsSchema = mapper.readValue(new File(paramsFilePath), DocumentLayoutParamsSchema.class);
	...
	public void ingest(DocumentLayoutParamsSchema paramsSchema, DatasetIngest datasetIngest)
			throws IOException {
